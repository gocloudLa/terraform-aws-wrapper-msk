module "msk" {
  ...
  configuration_description                     = try(each.value.configuration_description, var.msk_defaults.configuration_description, "${local.common_name}-${each.key} MSK Configuration")
  configuration_name                            = try(each.value.configuration_name, var.msk_defaults.configuration_name, "${local.common_name}-${each.key}-configuration")
  ...
  encryption_in_transit_in_cluster              = try(each.value.encryption_in_transit_in_cluster, var.msk_defaults.encryption_in_transit_in_cluster, true)
  enhanced_monitoring                           = try(each.value.enhanced_monitoring, var.msk_defaults.enhanced_monitoring, "DEFAULT")
