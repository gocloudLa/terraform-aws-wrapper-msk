...
GoCloud builds Terraform **wrapper modules** that are part of the [Standard Platform](https://github.com/gocloudLa/terraform-aws-standard-platform): a layered AWS infrastructure solution (Organization → Base → Foundation → Project → Workload). Each wrapper either:
